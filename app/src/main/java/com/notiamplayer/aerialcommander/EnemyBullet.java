...
public class EnemyBullet extends Sprite {
    ...
    public EnemyBullet(GameView view, float startX, float startY, float startDX, float startDY, int damage) {
        ...
        this.image = BitmapFactory.decodeResource(view.getResources(), R.drawable.spr_enemy_bullet);
    }
